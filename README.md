# Adobe Commerce Admin Developer

This repository is used to store the code for the [Commerce Admin Developer documentation](https://developer.adobe.com/commerce/admin-developer/) website. It is built using the [Adobe Edge Delivery Services](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/overview) and deployed to [Adobe Developer](https://developer.adobe.com/commerce/admin-developer/).

This site contains the latest Adobe Commerce and Magento Open Source developer documentation for ongoing releases, including design patterns, style guides, and best practices for Admin UI development.
