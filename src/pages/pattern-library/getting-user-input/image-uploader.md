...
![Image uploader via browser](../../_images/pattern-library/image-uploader-browse.jpg)
...
![Image uploader via drag and drop](../../_images/pattern-library/image-uploader-drag.jpg)

**Uploading Video Content:**

To upload a video to the Admin application the user taps the "Add Video" button.

![Add video button](../../_images/pattern-library/image-uploader-video-button.jpg)

![Video uploaded](../../_images/pattern-library/image-uploader-video-uploaded.jpg)
...
![Video uploader panel](../../_images/pattern-library/image-uploader-video-panel.jpg)
...
![Image uploader arrange](../../_images/pattern-library/image-uploader-arrange.jpg)
...
![Image uploader settings](../../_images/pattern-library/image-uploader-settings.jpg)

**Deleting an Image:**

Likewise, an image may be removed from the Admin application by tapping the "trashcan" icon.

![Image uploader delete](../../_images/pattern-library/image-uploader-delete.jpg)

## Dimensions

![Multi image uploader style](../../_images/pattern-library/multi-image-uploader-style.jpg)
